...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 28 10:56:08 2019
...
if __name__ == "__main__":
  ...
  #  tf.config.experimental.set_memory_growth(physical_devices[0], True)
    ...
    mcp_save = ModelCheckpoint('J:/screenacc/CNN/homo.h5', save_best_only=True, monitor='val_loss', mode='min')
    ...
    history = model.fit(X_train, Y_train, epochs=200, callbacks=[earlyStopping, mcp_save, reduce_lr_loss], validation_split=0.1)
    ...
    # predict
    model = load_model('J:/screenacc/CNN/homo.h5')
