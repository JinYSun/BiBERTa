# -*- coding: utf-8 -*-
"""
Created on Fri Jun 28 11:23:10 2024
...
# -*- coding: utf-8 -*-
"""
Created on Tue May  7 21:15:44 2024
...
if __name__ == "__main__":
    ...
    for i, inc in enumerate(tqdm(dono)):
        ...
        if mol is None:
            ...
            smi =AllChem. GetMorganFingerprintAsBitVect(mol, 3,1024)
            smi = smi.ToBitString()
            a = split_string(smi)
            a = np.array(a)
  ...
  #  tf.config.experimental.set_memory_growth(physical_devices[0], True)
    ...
    X_test=np.hstack((don,acc))#
    Y_test=targets
    n_features=10

    model = lgb.LGBMRegressor(objective='regression', num_leaves=31, learning_rate=0.1, n_estimators=20)
